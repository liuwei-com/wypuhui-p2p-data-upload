 ...
 * @Description:    存量与实时数据之间差
 */
@Component("uploadBaihangDValueService")
public class UploadBaihangDValueService {

    private static Logger logger = LoggerFactory.getLogger(UploadBaihangDValueService.class);
    ...
    private File createTxt(String startTime,String endTime,String fileName) throws IOException {
        File file = new File(fileName+".txt");
        FileOutputStream fileOutputStream = new FileOutputStream(file);
        PrintWriter printWriter = new PrintWriter(fileOutputStream);
        printWriter.println(createApplyLoanInfoData(startTime, endTime));
        printWriter.println(createLoanAccountInfoData(startTime, endTime));
        printWriter.println(createLoanAfterInfoData(startTime, endTime));
        printWriter.flush();
        printWriter.close();
